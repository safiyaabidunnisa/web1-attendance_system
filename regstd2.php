...
$err = mysqli_error($con);
	...
	{
		echo "<script>alert('Seems an user with given id or email already exists');window.location.replace('/safiya_project/web_html/stdprt2.php');</script>";
...
{
	echo "<script>alert('Registration Successful');window.location.replace('/safiya_project/web_html/stdprt2.php');</script>";
}
