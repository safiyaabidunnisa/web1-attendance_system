...
echo "<div align=\"center\">
					<a href=\"vadminstuattper.php\" style=\"text-decoration:none;color:white;\">Get Attendance Percentage</a>
					</div>
					<div align=\"right\">	
					<a href=\"vatte2.php\" style=\"text-decoration:none;color:white;\">Back</a>
					</div>";
					echo "<style>
td{
	color:white;
